...
type Context struct {
	...
	qodanaYamlForCli          QodanaYamlConfig
...
func (c Context) QodanaYamlConfig() QodanaYamlConfig { return c.qodanaYamlForCli }
...
func (b ContextBuilder) Build() Context {
	return Context{
		...
		qodanaYamlForCli:          b.QodanaYamlConfig,
	}
}
...
func (c Context) LocalQodanaYamlExists() bool {
	path := qdyaml.GetLocalNotEffectiveQodanaYamlPathWithProject(c.ProjectDir(), c.CustomLocalQodanaYamlPath())
	info, _ := os.Stat(path)
	return info != nil
}
